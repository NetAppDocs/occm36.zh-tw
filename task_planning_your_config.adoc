...
* https://["支援的組態Cloud Volumes ONTAP 、適用於支援的支援"^]
* https://["支援的支援組態ONTAP 、適用於支援的Cloud 9.3"^]
...
* https://["儲存限制Cloud Volumes ONTAP"^]
* https://["儲存限制Cloud Volumes ONTAP"^]
* https://["適用於NetApp的儲存限制ONTAP 9.3"^]
...
--
EBS 磁碟類型:: 通用 SSD 是 Cloud Volumes ONTAP 最常見的磁碟類型。若要檢視 EBS 磁碟的使用案例、請參閱 http://["AWS 文件： EBS Volume 類型"^]。
